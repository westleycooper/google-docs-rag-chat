 ...
 */
import type { EvaluationConfigOutJudgeModel } from './evaluationConfigOutJudgeModel';
import type { EvaluationConfigOutRerankModel } from './evaluationConfigOutRerankModel';

export interface EvaluationConfigOut {
  candidate_limit: number;
  chat_model: string;
  embedding_dimensions: number;
  embedding_model: string;
  judge_model: EvaluationConfigOutJudgeModel;
  prompt_version: string;
  rerank_enabled: boolean;
  rerank_model: EvaluationConfigOutRerankModel;
