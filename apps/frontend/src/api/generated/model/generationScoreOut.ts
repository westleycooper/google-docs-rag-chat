 ...
 */
import type { GenerationScoreOutRationale } from './generationScoreOutRationale';

export interface GenerationScoreOut {
  answer_relevance: number;
  citation_correctness: number;
  faithfulness: number;
  /** Low faithfulness with high relevance: fluent, confident and wrong. Named rather than averaged away because the citations make it look verified. */
  is_hallucinating: boolean;
  rationale: GenerationScoreOutRationale;
}
