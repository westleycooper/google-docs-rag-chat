 ...
 */
import type { CaseResultOutError } from './caseResultOutError';
import type { CaseResultOutGeneration } from './caseResultOutGeneration';
import type { CaseResultOutRetrieval } from './caseResultOutRetrieval';

export interface CaseResultOut {
  case_id: string;
  error: CaseResultOutError;
  generation: CaseResultOutGeneration;
  latency_ms: number;
  retrieval: CaseResultOutRetrieval;
}
